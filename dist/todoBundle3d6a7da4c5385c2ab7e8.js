...
/***/ "./src/helpers/dates/dateHelpers.js":
/*!******************************************!*\
  !*** ./src/helpers/dates/dateHelpers.js ***!
  \******************************************/
...
/* harmony export */   "updateTodaysDate": () => (/* binding */ updateTodaysDate)
/* harmony export */ });
...
function updateTodaysDate() {
  var today = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'E-do');
...
function formatDate(date) {
  ...
  var formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(newDate, 'E-dd-MM-yyyy');
...
/* harmony export */ });
/* harmony import */ var _projectElementFactory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectElementFactory */ "./src/helpers/factoryFunctions/projectElementFactory.js");

function createProjectListItem(project) {
  var projectsList = document.querySelector('.projectsList');
  var projectLi = (0,_projectElementFactory__WEBPACK_IMPORTED_MODULE_0__["default"])(project, {
    "class": 'project-li'
  });
  projectsList.appendChild(projectLi);
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createProjectListItem);

/***/ }),

/***/ "./src/helpers/factoryFunctions/elementFactory.js":
/*!********************************************************!*\
  !*** ./src/helpers/factoryFunctions/elementFactory.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/helpers/factoryFunctions/projectElementFactory.js":
/*!***************************************************************!*\
  !*** ./src/helpers/factoryFunctions/projectElementFactory.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (projectElementFactory);

/***/ }),

/***/ "./src/helpers/factoryFunctions/todoElementFactory.js":
/*!************************************************************!*\
  !*** ./src/helpers/factoryFunctions/todoElementFactory.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function todoElementFactory(todo, type, attributes) {
  var element = document.createElement(type);
  for (var key in attributes) {
    element.setAttribute(key, attributes[key]);
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (todoElementFactory);
...
function createTodoListItem(todo) {
  var todoList = document.querySelector('.todoList');
  var todoLi = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'li', {
    "class": 'todoListItem'
  });
  var checkIcon = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'div', {
    "class": 'checkIcon'
  });
  var todoTitle = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'p', {
    "class": 'todoTitle'
  }, 'title');
  var todoDescription = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'p', {
    "class": 'todoDescription'
  }, 'description');
  var todoPriority = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'p', _defineProperty({
    "class": 'todoPriority'
  }, "class", "".concat(todo.priority.split(': ')[1])), 'priority');
  var todoDate = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'p', {
    "class": 'todoDate'
  }, 'date');
  var todoProject = (0,_helpers_factoryFunctions_todoElementFactory__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, 'p', {
    "class": 'todoProject'
  }, 'project');

  // checkIcon.innerHTML = 'Icon'

  var tickIcon = (0,_helpers_factoryFunctions_elementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])('span', {
    "class": 'material-symbols-outlined tick'
  }, 'done');
  checkIcon.addEventListener('click', function (e) {
    var index = checkIcon.closest('li').id;
    console.log(allLocalStorageTodos);
    allLocalStorageTodos.splice(index, 1);
    localStorage.setItem('allTodos', JSON.stringify(allLocalStorageTodos));
    clearTodos();
  ...
  checkIcon.addEventListener('mouseenter', function (e) {
    console.log('CHECKED!!!!!!!!!!!!');
    checkIcon.appendChild(tickIcon);
  });
  checkIcon.addEventListener('mouseout', function (e) {
    if (e.relatedTarget.className === 'todoListItem') {
      checkIcon.removeChild(checkIcon.lastChild);
    }
  });
...
var getFit = new Project('Get Fit', 'blue');
var readBooks = new Project('Read Books', 'yellow');
getFit.tasks.push({
  title: 'Push',
  description: 'Chest',
  priority: 'High'
...
// }
console.log(allLocalStorageTodos);
var displayAllTodos = function displayAllTodos(todoArr) {
...
cancelTodoWrapper.addEventListener('click', function (e) {
  e.preventDefault();
  // console.log('cancel')
  clearForm();
  todoForm.style.display = 'none';
...
showHideProject.addEventListener('click', function (e) {
  // console.log('expand!!!!')
  e.preventDefault();
...
/******/ })()
;
//# sourceMappingURL=todoBundle3d6a7da4c5385c2ab7e8.js.map